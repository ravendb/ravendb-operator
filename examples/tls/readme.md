...
✅ You don’t need to manually rotate certificates - RavenDB handles this seamlessly.
...
🔒 Ensure the server.pfx includes the correct wildcard CN and SANs to match all advertised URLs.
...
| ------------- | ----------  | -------------  | -----------------  |
| Let's Encrypt | ✅ Full     | Let's Encrypt | ✅ Automatic       | 
| Self-Signed   | ❌ Manual   | Custom CA     | ❌ Manual Rotation | 



We strongly recommend using **Let's Encrypt with RavenDB’s built-in support**. RavenDB does the hard work for you when you let it. 
This approach offloads all the cumbersome work of certificate management—generation, renewal, replacement, and propagation - directly to RavenDB. It’s secure, automated, and production-ready out of the box.
...
- `examples/tls/letsencrypt/ravendb_v1_ravendbcluster_letsencrypt.yaml`
- `examples/tls/selfsigned/ravendb_v1_ravendbcluster_selfsigned.yaml`

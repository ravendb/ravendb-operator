...
## What's Changed
* RavenDB-26402: Kubernetes Operator: Introduce RavenDBCluster Helm Chart by @TheGoldenPlatypus in https://github.com/ravendb/ravendb-operator/pull/32
* release: v2.0.0 by @poissoncorp in https://github.com/ravendb/ravendb-operator/pull/36


**Full Changelog**: https://github.com/ravendb/ravendb-operator/compare/v1.1.0...v2.0.0
